        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
                ...
                <tr>
                    ...
                    <td>
                       <?php echo $form->input('Setting.mobile',array( 'label' => '','class'=>'text-input medium-input datepicker','maxlength'=>'30'));?>
                    </td>
                </tr>                
                <tr>
                ...
                <tr>
                   	<td width="120" class="label">Lượng tuy cập</td>
                    <td>                    
                    <?php echo $form->input('Setting.name_en',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </td>
                </tr>
                <!--<tr>
                	<td class="label">Thông tin chi nhánh công ty 1:</td>
                	<td>
                    <?php  echo $this->Form->input('Setting.content',array('label' => '','type'=>'textarea')).$this->TvFck->create('Setting.content',array('toolbar'=>'extra','skin'=>'kama','height'=>'250px','width'=>'700')); ?>
                    </td>
                </tr>
                <tr>
                	<td class="label">Thông tin chi nhánh công ty 2:</td>
                	<td>
                    <?php  echo $this->Form->input('Setting.descriptions',array('label' => '','type'=>'textarea')).$this->TvFck->create('Setting.descriptions',array('toolbar'=>'extra','skin'=>'kama','height'=>'250px','width'=>'700')); ?>
                    </td>
                </tr>-->
                <!--<tr>
                ...
                <tr>
                	...
                	<td>
                    <?php  echo $this->Form->input('Setting.information',array('label' => '','type'=>'textarea')).$this->TvFck->create('Setting.information',array('toolbar'=>'extra','skin'=>'kama','height'=>'250px','width'=>'700')); ?>
                    </td>
                </tr>
                 <tr>
                	<td class="label">Thông tin Footer( Chân trang):</td>
                	<td>
                    <?php  echo $this->Form->input('Setting.content',array('label' => '','type'=>'textarea')).$this->TvFck->create('Setting.content',array('toolbar'=>'extra','skin'=>'kama','height'=>'250px','width'=>'700')); ?>
                    </td>
                </tr>
                <tr>
                	<td class="label">Đối tác( Chân trang):</td>
                	<td>
                    <?php  echo $this->Form->input('Setting.doitac',array('label' => '','type'=>'textarea')).$this->TvFck->create('Setting.doitac',array('toolbar'=>'extra','skin'=>'kama','height'=>'250px','width'=>'700')); ?>
                    </td>
                </tr>
                <tr>

                ...
                <tbody>
                   <?php $i=1; foreach ($Catproduct as $key =>$value){?>
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $value['Catproduct']['char'];?></td>
                        <td style="text-align:center;">
                        <?php if($value['Catproduct']['show']==1 && $value['Catproduct']['parent_id']!=null){?>
                            <a href="<?php echo DOMAINAD?>catproducts/closeindex/<?php echo $value['Catproduct']['id'] ?>" title="Tích vào để không hiển thị mục này" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/success-icon.png" alt="Tích vào để không hiển thị mục này" /></a>
                        <?php }?>
                        <?php if($value['Catproduct']['show']==0 && $value['Catproduct']['parent_id']!=null){?>
                            <a href="<?php echo DOMAINAD?>catproducts/activeindex/<?php echo $value['Catproduct']['id'] ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                            <?php }?>
                        </td>

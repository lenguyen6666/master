                   ...
                   <?php $i=1; foreach ($category as $key =>$value){?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <?php if($value['Category']['show']==1 && $value['Category']['parent_id']==224){?>
                                <a href="<?php echo DOMAINAD?>category/closeindex/<?php echo $value['Category']['id'] ?>" title="Tích vào để không hiển thị mục này" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/success-icon.png" alt="Tích vào để không hiển thị mục này" /></a>
                            <?php }?>
                            <?php if($value['Category']['show']==0 && $value['Category']['parent_id']==224){?>
                            <a href="<?php echo DOMAINAD?>category/activeindex/<?php echo $value['Category']['id'] ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                            <?php }?>
                        </td>

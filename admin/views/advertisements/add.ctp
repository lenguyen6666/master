        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
                ...
                <tr>
                    ...
                    <td>
                    <?php echo $this->Form->input('Advertisement.images',array('class'=>'text-input image-input datepicker','name' => 'userfile'));?> &nbsp;<font color="#FF0000"> <a href="javascript:window.open('<?php echo DOMAINAD; ?>upload.php','userfile','width=500,height=300');window.history.go(1)" >[ upload ]</a> </font><font color="#FF0000">*</font>(jpg, jpeg, gif, png)
                ...
                <tr>
                    ...
                    <input type="radio" value="0" id="AdvertisementDisplay0" name="data[Advertisement][display]"> Quảng cáo trái
                    	&nbsp;&nbsp;&nbsp;<input type="radio" value="1" id="AdvertisementDisplay1" name="data[Advertisement][display]"> Quảng cáo phải
                        &nbsp;&nbsp;&nbsp;<input type="radio"  value="2" id="AdvertisementDisplay2" name="data[Advertisement][display]"> Quảng cáo Giữa
                    </td>
                </tr>
             <tr>

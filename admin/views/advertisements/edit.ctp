        	...
        	<table class="input">
                ...
                <tr>
                    ...
                    <input type="radio" value="0" <?php if($this->data['Advertisement']['display'] == 0 ) echo "checked='checked'"; ?> id="AdvertisementDisplay0" name="data[Advertisement][display]"> Quảng cáo trái
                        ...
                        &nbsp;&nbsp;&nbsp;<input type="radio" <?php if($this->data['Advertisement']['display'] == 2 ) echo "checked='checked'"; ?> value="2" id="AdvertisementDisplay2" name="data[Advertisement][display]"> Quảng cáo gữi
                    </td>
                </tr>
             <tr>

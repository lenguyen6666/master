<?php echo $form->create(null, array( 'url' => DOMAINAD.'menus/add','type' => 'post','name' => 'adminForm', 'inputDefaults' => array('label' => false,'div' => false)));?>	   
<div id="khung">
	<div id="main">
            ...
            <table class="input">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <p>
                    <input type="radio" name="radio" value="1" onclick="showMe('div1', 'div2', 'div3', this)" /> 
                    Link &nbsp;  &nbsp;
                    <input type="radio" name="radio" value="2" onclick="showMe('div2', 'div3', 'div1', this)" />
                    Chọn Module sản phẩm&nbsp;  &nbsp;
                    <input type="radio" name="radio" value="3" onclick="showMe('div3', 'div1', 'div2', this)" />
                    Chọn Module tin tức
                    </p>
                ...
                <tr>
                    ...
                    <td>
                    <input type="radio" value="0" id="Menutatus0" name="data[Menu][status]"> Chưa Active 
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="Menutatus1" name="data[Menu][status]"> Đã Active
                    </td>
                </tr>
                <!--<tr>

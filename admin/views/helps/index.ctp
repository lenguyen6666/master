...
<div id="khung">
	<div id="main">
        ...
        <div class="pagetitle icon-48-nhomtin"><h2>Quản lý hotline</h2></div>
		<div class="clr"></div>
	</div>
</div>
 <?php echo $form->end(); ?>
<div class="content-box">
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <table>
              <form action="<?php echo DOMAINAD; ?>helps/processing" name="form1" method="post">  
                <thead>
                    <tr>

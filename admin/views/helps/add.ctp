    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
               ...
               <tr>
                  	<td class="label">Tên Yahoo 2</td>
                    <td>
                     <?php echo $this->Form->input('Help.user_yahoo1',array('class'=>'text-input medium-input datepicker','maxlength' => '250','onchange' => 'get_alias()','id' => 'idtitle'));?>
                    </td>
                </tr>
                <tr>

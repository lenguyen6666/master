                        ...
                        <?php  foreach($news as $itm){ ?>
                            <div class="intro-content" style="margin: 10px 0; padding: 5px 0;">                           
                                   ...
                                   <div style="padding-left: 140px;"> 
                                    <h3>
                                        <a  style="color: #237BA0 !important;" href="<?php echo DOMAIN?>tin-tuc/chi-tiet-tin/<?php echo $itm['News']['id']?>">
                                            <?php echo strip_tags($this->Text->truncate( $itm['News']['title_en'],130,array('ending' => '...','exact' => false)));?></a>
                                        </a>
                                    </h3>     
                                    <div>	                                                        		
                                   		<?php echo strip_tags($this->Text->truncate( $itm['News']['introduction_en'],290,array('ending' => '...','exact' => false)));?>
                                    </div>
                                    </div>
                                    <div class="detail" align="right">
                                    	<a href="<?php echo DOMAIN?>tin-tuc/chi-tiet-tin/<?php echo $itm['News']['id']?>">
